        ...
        <div class="main-panel">
          ...
          <div class='alert alert-success'>
            ...
            <div class='div_center'>
                ...
                <input class='text_colour' type='number' name='price' placeholder='Write a price' required=''>
                </div>

                <div class='div_design'>
                <label>Discount Price</label>
                <input class='text_colour' type='number' name='dis_price' placeholder='Write a discount'>
                </div>

                <div class='div_design'>
                <label>Product Quantity</label>
                <input class='text_colour' type='number' min='0' name='quantity' placeholder='Write a number' required=''>
                </div>
